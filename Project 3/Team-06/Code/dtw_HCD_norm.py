# code for DTW on 2D handwritten character dataset. performs DTW after normalizing the data set
...
outfolder = str(input('Enter a string N. The plots will be saved in N_HCDDTW_Norm_Results: ')) + '_HCDDTW_Norm_Results'
