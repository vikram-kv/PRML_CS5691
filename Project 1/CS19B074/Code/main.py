...
# refresh the solution directory
for dir in os.listdir('solution'):
    shutil.rmtree('solution/'+dir)

# work the problem(s) in a loop
for f in os.listdir('dataset'):
    os.makedirs('solution/'+os.path.basename(f).split('.',1)[0])    # form solution directory structure
